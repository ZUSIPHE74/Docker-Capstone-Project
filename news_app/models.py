"""
Models for the news_app application.
Defines Publishers, Users, Articles, and Newsletters.
"""
...
class Article(models.Model):
    """Represents a news article submitted by a journalist and reviewed by an editor."""
